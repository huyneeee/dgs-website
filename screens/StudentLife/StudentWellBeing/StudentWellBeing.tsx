...
import { studentWellBeing } from '@/services/studentWellBeing';
import { useLocale } from 'next-intl';
import React, { use } from 'react';

const StudentWellBeing = () => {
  const locale = useLocale();
  const studentWellBeingData = use(
    studentWellBeing.getStudentWellBeing(locale),
  );

  const content = studentWellBeingData.data;
